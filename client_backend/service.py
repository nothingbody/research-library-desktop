...
class Application:
    ...
    def call(self, method, p):
        ...
        if method in {'items.create', 'browser.capture', 'browser.importDownloaded', 'items.update', 'items.bulk', 'items.merge', 'items.undoMerge', 'collections.edit', 'attachments.setRole',
                      ...
                      'aiSearch.create', 'aiSearch.savePlan', 'aiSearch.run', 'aiSearch.expand', 'aiSearch.citationExpand', 'aiSearch.rerank', 'aiSearch.import', 'aiSearch.cancel', 'aiSearch.verify', 'aiSearch.decision', 'searchEvaluation.save',
