...
当前版本：**0.9.35**。项目仍在开发中，升级前请先备份个人文献库。软件不是 Scholay、知网、Elsevier、Zotero 或其他学术平台的官方客户端。
...
1. 将 PDF 从文件管理器拖到“我的文献”即可直接添加并建立全文索引；重复 PDF 会归入已有条目。RIS、BibTeX/BibLaTeX、CSL-JSON 以及无法自动解析的 PDF 会先显示导入预览，核对后再保存。
